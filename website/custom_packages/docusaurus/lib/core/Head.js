...
class Head extends React.Component {
  render() {
    ...
    // console.log('head.js line 34', this.props);
    ...
    return (
      <head>
        ...
        {/* edited here */}
        {
          this.props.customMetaData && this.props.customMetaData.map((cProp, index) => {
            return <meta key={index} name={cProp.name} content={cProp.content}/>
          })
        }
